...
function Gamestart(coin, current_progress){
    return(
        <>
           <section className='part-choose'>
           <div class="card">
                <Link to="/charter01" class="item item--1">
                    ...
                    <span class="quantity"> 中文之美 </span>
                    <span class="text text--1"> chinese </span>
                </Link>
                <Link to="/charter02" class="item item--2">
                    ...
                    <span class="quantity"> 数字谜踪 </span>
                    <span class="text text--2"> mathematic </span>
                </Link>
                <Link to="/charter03" class="item item--3">
                    ...
                    <span class="quantity"> 异域风情 </span>
                    <span class="text text--3"> English </span>
                </Link>
                <Link to="/charter04" class="item item--4">
                    ...
                    <span class="quantity"> 拓展挑战 </span>
                    <span class="text text--4"> Expansion  </span>
                </Link>
            </div>

            <div class="display-box">
                <br/>
                <span class="content1"> 请选择章节开始您的挑战吧 </span>
                <span class="content2">点击“中文之美”章节以进入新手指引关卡 </span>
                <br/>
            </div>
           </section>
        </>
